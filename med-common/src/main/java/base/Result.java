...
public class Result<T> {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> fail(RetrivalErrorCode code) {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> fail(RetrivalErrorCode code, Object... args) {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> failWithData(RetrivalErrorCode error, T data) {
